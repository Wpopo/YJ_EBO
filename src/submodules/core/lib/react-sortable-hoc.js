          ...
          function(event) {
            ...
            if (
              ...
              var _node$sortableInfo = node.sortableInfo,
                ...
                locked = _node$sortableInfo.locked;
      ...
      _createClass(WithSortableContainer, [
        ...
        },
        {
          ...
          value: function animateNodes() {
            ...
            var isAllowedToMoveToNode = function isAllowedToMoveToNode(_ref3) {
              var node = _ref3.node;
              return !node.sortableInfo.locked;
            };

            var findNextSortIndex = function findNextSortIndex(
              index,
              direction
            ) {
              var predicate =
            ...
            var _loop = function _loop(i, len) {
              ...
              var offset = {
                height: _this4.height > height ? height / 2 : _this4.height / 2,
                width: _this4.width > width ? width / 2 : _this4.width / 2,
              };
              var mustShiftBackward =
                isKeySorting && index > _this4.index && index <= prevIndex;
              ...
              if (!edgeOffset) {
                edgeOffset = getEdgeOffset(node, _this4.container);
              ...
              var getNextEdgeOffset = function getNextEdgeOffset(direction) {
                var nextSortIndex = findNextSortIndex(i, direction);
                var nextSortIndexOwner = nodes[nextSortIndex];
                return getEdgeOffset(nextSortIndexOwner.node, _this4.container);
              };
              ...
              if (_this4.axis.x) {
                if (_this4.axis.y) {
                  if (
                    ...
                    var nextEdgeOffset = getNextEdgeOffset(DIRECTION.FORWARD);
                    translate.x = nextEdgeOffset.left - edgeOffset.left;
                    translate.y = nextEdgeOffset.top - edgeOffset.top;

                    if (_this4.newIndex === null) {
                      _this4.newIndex = index;
                    }
                  } else if (
                    mustShiftBackward ||
                    (index > _this4.index &&
                    ...
                    var _nextEdgeOffset = getNextEdgeOffset(DIRECTION.BACKWARD);

                    translate.x = _nextEdgeOffset.left - edgeOffset.left;
                    translate.y = _nextEdgeOffset.top - edgeOffset.top;
                    _this4.newIndex = index;
                  }
                } else {
                  if (
                    ...
                    var _nextEdgeOffset2 = getNextEdgeOffset(
                      DIRECTION.BACKWARD
                    );

                    translate.x = _nextEdgeOffset2.left - edgeOffset.left;
                    _this4.newIndex = index;
                  } else if (
                    mustShiftForward ||
                    (index < _this4.index &&
                    ...
                    var _nextEdgeOffset3 = getNextEdgeOffset(DIRECTION.FORWARD);

                    translate.x = _nextEdgeOffset3.left - edgeOffset.left;
                ...
                if (
                  ...
                  var _nextEdgeOffset4 = getNextEdgeOffset(DIRECTION.BACKWARD);

                  translate.y = _nextEdgeOffset4.top - edgeOffset.top;
                  _this4.newIndex = index;
                } else if (
                  mustShiftForward ||
                  (index < _this4.index &&
                  ...
                  var _nextEdgeOffset5 = getNextEdgeOffset(DIRECTION.FORWARD);

                  translate.y = _nextEdgeOffset5.top - edgeOffset.top;
